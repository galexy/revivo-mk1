...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "opening_balance_amount", sa.Numeric(precision=19, scale=4), nullable=False
        ),
        ...
        sa.Column(
            "credit_limit_amount", sa.Numeric(precision=19, scale=4), nullable=True
        ),
    ...
    op.create_index(
        "ix_accounts_user_status", "accounts", ["user_id", "status"], unique=False
    )
    op.create_index(
        "ix_accounts_user_type", "accounts", ["user_id", "account_type"], unique=False
    )
    op.create_table(
        "categories",
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_encrypted_secrets_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_encrypted_secrets")),
    )
    op.create_index(
        "ix_encrypted_secrets_user_type",
        "encrypted_secrets",
        ["user_id", "secret_type"],
        unique=True,
    )
    ...
    op.create_index(
        "ix_refresh_tokens_family", "refresh_tokens", ["token_family"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "default_category_id", types.CategoryIdType(length=36), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_payees_user_id_users")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "source_transaction_id", types.TransactionIdType(length=36), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["payee_id"], ["payees.id"], name=op.f("fk_transactions_payee_id_payees")
        ),
        sa.ForeignKeyConstraint(
            ["source_transaction_id"],
            ["transactions.id"],
            name=op.f("fk_transactions_source_transaction_id_transactions"),
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        "ix_split_lines_category_id", "split_lines", ["category_id"], unique=False
    )
    op.create_index("ix_split_lines_split_id", "split_lines", ["split_id"], unique=True)
    op.create_index(
        "ix_split_lines_transaction_id", "split_lines", ["transaction_id"], unique=False
    )
    op.create_index(
        "ix_split_lines_transfer_account",
        "split_lines",
        ["transfer_account_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_transactions_search", table_name="transactions", postgresql_using="gin"
    )
