...
<task type="auto">
  ...
  <verify>
    ...
    - **Visual (Chrome):** Use Claude Code Chrome to open http://localhost:5173 and take a screenshot. Confirm: (1) Tailwind styling applied (not unstyled HTML), (2) Inter font renders for body text, (3) JetBrains Mono renders for financial figures, (4) negative amount shows in red. Then click the dark mode toggle and screenshot again to confirm theme switch works.
  </verify>
...
7. **Visual (Chrome):** Screenshot light mode and dark mode — Tailwind styling, fonts, and theme toggle all confirmed visually
</verification>
