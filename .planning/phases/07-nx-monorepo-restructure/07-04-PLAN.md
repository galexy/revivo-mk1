...
<task type="auto">
  ...
  7. Commit: `git add CLAUDE.md && git commit -m "docs(07): update CLAUDE.md for monorepo structure"`
  </action>
  <verify>
  ...
  <done>CLAUDE.md documents monorepo layout, import conventions, Nx commands, and future shadcn/ui path</done>
</task>
