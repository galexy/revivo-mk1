...
@.planning/phases/04-authentication-infrastructure/04-07-SUMMARY.md
@tests/conftest.py
@tests/integration/api/test_accounts.py
@tests/integration/api/test_transactions.py
@tests/integration/api/test_categories.py
...
<task id="1">
  ...
  <action>
Update all existing integration tests to pass `auth_headers` to protected endpoint calls. The auth_headers fixture was created in 04-06 (tests/conftest.py).
